...
<div class="content">
    ...
    <p class="stat"><span class="number"></span></p>
           ...
           <p></p>
           <center>   
              <div class="row-fluid" style="background-color:#EFEFEF; height:670px;">
                <div class="dialog">
                    <div class="block" style="background-color:#CADAE7; text-align:left;">
                        <p class="block-heading" align="center">添加用户</p>
                        <div class="block-body">
                            <form action="manageradduser.php" method="post" name="form" onSubmit="return validate_form(this)">
                            <label>用户名</label>
                            ...
                            <label>验证码</label>
                            <input type="text" name="input" style="width:80px"/>&nbsp;<input type="button" name="checkCode" class="code" style="width:80px" value="点击获取" onClick="createCode()" /> <a href="#" onClick="createCode()">看不清楚</a>
                            <!-- <a href="index.html" class="btn btn-primary pull-right" onclick="submitForm(document.myform)" >登录</a> -->
                            <input type="reset" name="reset" value="重置" class="btn btn-primary pull-right"/>
        ...
        <p><a href="index.php">返回</a>岐黄养生</p>
                </div>
            </div>
      </center>
</div>
